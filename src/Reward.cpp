...
void Reward::select(string &aco, string &tg) { // 根据哪个字段查询,目标值是多少
    string ctl = "select * from reward where " + aco + "=" + tg + ";";
...
void Reward::mdelete(string &aco, string &tg, string &key, string &keytg) {
    string ctl = "delete from reward where " + aco + "=" + tg + " and " + key +
                 "= " + keytg + ";";
...
void Reward::update(string &upd, string &updtg, string &aco, string &tg) {

    string ctl = "update reward set " + upd + "=" + updtg + "  where " + aco +
                 "=" + tg + ";";
